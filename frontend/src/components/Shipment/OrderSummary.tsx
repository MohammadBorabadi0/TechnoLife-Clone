...
const OrderSummary: FC<IProps> = ({ cartItems }) => {
  const {
    totalDiscountAmount,
    totalPrices,
  ...
  return (
    <div className="flex flex-1 flex-col gap-5 px-3 py-6 mt-5 bg-[#f6f6f6] text-sm border-t mb-20">
      ...
      <div className="flex justify-between items-center text-black lg:text-base font-semibold border-t pt-5">
